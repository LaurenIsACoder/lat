...
KHASH_MAP_DECLARE_STR(symbol1map, symbol1_t)
...
int getSymbolInMaps(library_t *lib, const char* name, khint_t pre_k, int noweak, uintptr_t *addr, uintptr_t *size, int version, const char* vername, int local);  // Add bridges to functions
