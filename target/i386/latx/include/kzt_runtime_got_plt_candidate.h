...
typedef struct kzt_runtime_got_plt_candidate_request {
    ...
    /* Production can audit one already-selected relocation without needing
     * storage proportional to the object's complete relocation table. */
    int only_entry;
    kzt_patch_table_kind_t only_table_kind;
    size_t only_entry_index;
