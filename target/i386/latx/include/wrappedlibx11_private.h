...
GO(XkbGetNamedIndicator, iFpppppp)
...
GO(XSelectInput, iFppl)
GO(_XSend, vFppl)
GO(XSendEvent, iFppilp)
...
GO(XSetNormalHints, iFppp)
GO(XSetOCValues, pFpppppppppppppppp) // use vaarg
GO(XSetOMValues, pFpppppppppppppppp)
//GO(XSetPlaneMask
...
GO(XSetStandardProperties, iFppppppip)
//GO(XSetState
...
GOM(XTranslateCoordinates, iFpppiippp)
// _XTranslateKey
// _XTranslateKeySym
